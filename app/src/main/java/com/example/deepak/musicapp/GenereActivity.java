    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Album.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                ...
                Intent AlbumIntent = new Intent(GenereActivity.this, AlbumActivity.class);
        ...
        Artist.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                ...
                // creat new intent to open album activity
                Intent ArtistIntent = new Intent(GenereActivity.this, ArtistActivity.class);
        ...
        Genere.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                ...
                // creat new intent to open album activity
                Intent GenereIntent = new Intent(GenereActivity.this, GenereActivity.class);
        ...
        Playlist.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                ...
                // creat new intent to open album activity
                Intent PlaylistIntent = new Intent(GenereActivity.this, PlaylistActivity.class);
